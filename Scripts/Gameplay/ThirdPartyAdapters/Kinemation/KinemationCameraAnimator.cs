...
{
    public class KinemationCameraAnimator : MonoBehaviour
    {
        ...
        private KinemationController _player;
        ...
        private void Awake()
        {
            _player = transform.root.GetComponentInChildren<KinemationController>();
