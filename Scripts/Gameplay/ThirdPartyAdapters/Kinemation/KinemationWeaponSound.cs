...
{
    public class KinemationWeaponSound : MonoBehaviour
    {
        ...
        private void Awake()
        {
            _settings = transform.parent.GetComponent<KinemationWeapon>().weaponSettings;
        ...
        public void PlayFireSound()
        {
            ...
            _audioSource.PlayOneShot(KinemationPlayerSound.GetRandomAudioClip(_settings.fireSounds));
        }
